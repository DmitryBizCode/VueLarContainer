...
class RouteSeeder extends Seeder
{
    ...
    private function routeEdges(): array
    {
        return [
            ...
            ['Port of Kiel', 'Port of Aarhus', 1, 190.0],
            ['Port of Aarhus', 'Port of Kiel', 1, 190.0],
            ['Port of Rotterdam', 'Port of Antwerp', 1, 190.0],
            ['Port of Antwerp', 'Port of Rotterdam', 1, 190.0],
            ['Port of Antwerp', 'Port of Zeebrugge', 1, 130.0],
            ['Port of Zeebrugge', 'Port of Antwerp', 1, 130.0],
            ['Port of Rotterdam', 'Port of Amsterdam', 1, 95.0],
            ['Port of Amsterdam', 'Port of Rotterdam', 1, 95.0],
            ['Port of Antwerp', 'Port of Dunkirk', 2, 280.0],
            ['Port of Dunkirk', 'Port of Antwerp', 2, 280.0],
            ['Port of Dunkirk', 'Port of Le Havre', 1, 210.0],
            ['Port of Le Havre', 'Port of Dunkirk', 1, 210.0],
            ...
            ['Port of Southampton', 'Port of Felixstowe', 1, 260.0],
            ['Port of Felixstowe', 'Port of Southampton', 1, 260.0],
            ['Port of Felixstowe', 'Port of Dublin', 3, 520.0],
            ['Port of Dublin', 'Port of Felixstowe', 3, 520.0],
            ['Port of London', 'Port of Felixstowe', 1, 180.0],
            ['Port of Felixstowe', 'Port of London', 1, 180.0],
            ['Port of Cork', 'Port of Dublin', 1, 260.0],
            ['Port of Dublin', 'Port of Cork', 1, 260.0],
            ['Port of Rotterdam', 'Port of Felixstowe', 2, 310.0],
            ['Port of Felixstowe', 'Port of Rotterdam', 2, 310.0],
            ['Port of Hamburg', 'Port of Gdansk', 2, 780.0],
            ['Port of Gdansk', 'Port of Hamburg', 2, 780.0],
            ['Port of Gdansk', 'Port of Szczecin', 1, 380.0],
            ['Port of Szczecin', 'Port of Gdansk', 1, 380.0],
            ['Port of Hamburg', 'Port of Aarhus', 2, 520.0],
            ['Port of Aarhus', 'Port of Hamburg', 2, 520.0],
            ['Port of Aarhus', 'Port of Gothenburg', 1, 290.0],
            ['Port of Gothenburg', 'Port of Aarhus', 1, 290.0],
            ...
            ['Port of Riga', 'Port of Klaipeda', 1, 330.0],
            ['Port of Klaipeda', 'Port of Riga', 1, 330.0],
            ['Port of Klaipeda', 'Port of Gdansk', 1, 360.0],
            ['Port of Gdansk', 'Port of Klaipeda', 1, 360.0],
