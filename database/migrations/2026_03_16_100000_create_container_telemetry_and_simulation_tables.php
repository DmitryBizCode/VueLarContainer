...
/**
 * Historical filename: previously also covered telemetry; IoT readings now use `metrics` only.
 * This migration creates the simulation worker snapshot table (one row per container).
 */
