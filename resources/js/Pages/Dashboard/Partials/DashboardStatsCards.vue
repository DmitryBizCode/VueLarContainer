...
<template>
    <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <div class="min-w-0 overflow-x-clip rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            <p class="text-xs font-semibold uppercase tracking-wide text-slate-500">Active rentals</p>
            <p class="mt-2 break-words text-3xl font-extrabold tabular-nums text-slate-900">{{ stats.activeRentals }}</p>
        ...
        <div class="min-w-0 overflow-x-clip rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <p class="mt-2 break-words text-3xl font-extrabold tabular-nums text-slate-900">{{ stats.completedRentals }}</p>
        ...
        <div class="min-w-0 overflow-x-clip rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <p class="mt-2 break-words text-3xl font-extrabold tabular-nums text-slate-900">{{ stats.unreadNotifications }}</p>
        ...
        <div class="min-w-0 overflow-x-clip rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <p class="mt-2 break-words text-3xl font-extrabold tabular-nums text-slate-900">{{ stats.recentActivityCount }}</p>
