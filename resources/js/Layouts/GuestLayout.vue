...
<template>
    <div class="relative min-h-screen overflow-hidden bg-slate-950">
        ...
        <div class="relative z-10 mx-auto flex min-h-screen w-full max-w-7xl items-stretch px-4 py-6 sm:px-6 lg:px-8">
                    ...
                    <aside class="relative hidden border-r border-white/10 p-10 lg:flex lg:flex-col lg:justify-between">
                        <div>
                            <Link href="/" class="inline-flex items-center gap-3">
                                ...
                                <div>
                                    <p class="text-xs font-semibold uppercase tracking-[0.2em] text-blue-100/80">Logistics Platform</p>
                        ...
                        >
                            <div class="mb-6 flex items-center justify-between lg:hidden">
                                <Link href="/" class="inline-flex items-center gap-2">
                                    ...
                                    <span class="text-sm font-semibold text-blue-900">Logistics Platform</span>
                                </Link>
